...
<body class="overflow-x-hidden overflow-y-hidden lg:overflow-hidden antialiased text-[#172554]">
    @php
        $googleName = session('google_name', '');
        $googleNameParts = $googleName ? preg_split('/\s+/', trim($googleName)) : [];
        $googleFirstName = $googleNameParts[0] ?? '';
        $googleLastName = $googleNameParts ? $googleNameParts[count($googleNameParts) - 1] : '';
    @endphp
    ...
    <main class="grid min-h-screen lg:h-screen lg:grid-cols-[1.08fr_.92fr]">
        ...
        <section class="flex items-center justify-center overflow-hidden bg-[#002c76] px-5 py-5 sm:px-8 lg:px-10 lg:py-4">
            <div class="w-full max-w-[600px] rounded-[28px] bg-white px-5 py-5 shadow-[0_30px_70px_rgba(0,0,0,0.22)] sm:px-6 sm:py-6">
                @if (session('status'))
                    <div class="mb-3 rounded-2xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-700">
                        {{ session('status') }}
                    </div>
                @endif

                @if ($errors->any())
                    <div class="mb-3 rounded-2xl border border-red-100 bg-red-50 px-4 py-3 text-sm text-red-700">
                ...
                <h1 class="text-center text-[19px] font-extrabold tracking-[-0.03em] text-[#16265a]">Create your account</h1>
                <p class="mt-1 text-center text-[10px] text-slate-500">Build smarter, evidence-based governance for your local government unit</p>

                <form method="POST" action="{{ route('register') }}" class="mt-3">
                    @csrf

                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-4" x-data="{
                        ...
                        <div>
                            <label for="last_name" class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">Last Name <span class="text-orange-500">*</span></label>
                            <div class="relative">
                                ...
                                <input
                                    id="last_name"
                                    class="h-[40px] w-full rounded-2xl border border-[#d5dff1] bg-[#eef4ff] pl-12 pr-4 text-[12px] text-[#203150] outline-none transition focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-100"
                                    type="text"
                                    name="last_name"
                                    value="{{ old('last_name', $googleLastName) }}"
                                    required
                        ...
                        <div>
                            <label for="first_name" class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">First Name <span class="text-orange-500">*</span></label>
                            <div class="relative">
                                <span class="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                                        <circle cx="12" cy="8" r="4"></circle>
                                ...
                                <input
                                    ...
                                    type="text"
                                    name="first_name"
                                    value="{{ old('first_name', $googleFirstName) }}"
                                    required
                        ...
                        <div>
                            <label for="middle_initial" class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">M.I.</label>
                            <div class="relative">
                                <span class="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                                        <circle cx="12" cy="8" r="4"></circle>
                        ...
                        <div>
                            <label for="office_type" class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">Select Office <span class="text-orange-500">*</span></label>
                            <div class="relative">
                                <span class="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                                ...
                                <select
                                    id="office_type"
                                    name="office_type"
                                    class="h-[40px] w-full appearance-none rounded-2xl border border-[#d5dff1] bg-[#eef4ff] pl-12 pr-10 text-[12px] text-[#203150] outline-none transition focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-100"
                                    required
                                    x-model="officeType"
                                ...
                                <svg class="pointer-events-none absolute right-4 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8">
                                    <path d="M6 8l4 4 4-4" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                        </div>

                        <div class="sm:col-span-1" x-show="officeType" x-cloak>
                            <label class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">
                        ...
                        <div>
                            <label for="email" class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">Work Email <span class="text-orange-500">*</span></label>
                            <div class="relative">
                                <span class="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                        ...
                        <div>
                            <label for="password" class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">Password <span class="text-orange-500">*</span></label>
                            <div class="relative">
                                <span class="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                                ...
                                <input
                                    id="password"
                                    class="h-[40px] w-full rounded-2xl border border-[#d5dff1] bg-[#eef4ff] pl-12 pr-12 text-[12px] text-[#203150] outline-none transition focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-100"
                                    type="password"
                                    name="password"
                                    required
                                    minlength="12"
                        ...
                        <div>
                            <label for="password_confirmation" class="mb-2 block text-[10px] font-extrabold text-[#1b2b59] sm:text-[11px]">Confirm Password <span class="text-orange-500">*</span></label>
                            <div class="relative">
                                <span class="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                                        <rect x="3" y="11" width="18" height="10" rx="2"></rect>
                                ...
                                >
                                <button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 rounded-xl p-2 text-slate-400 transition hover:bg-blue-50 hover:text-[#1d4ed8]" id="confirmPasswordToggle" aria-label="Show password">
                                    <svg id="confirmEyeOpen" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                                        <path d="M2.5 12s3.8-7 9.5-7 9.5 7 9.5 7-3.8 7-9.5 7-9.5-7-9.5-7Z"></path>
                                        <circle cx="12" cy="12" r="3"></circle>
                                    </svg>
                                    <svg id="confirmEyeClosed" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="hidden h-4 w-4">
                                        <path d="M3 3l18 18"></path>
                                        <path d="M10.6 10.6a3 3 0 0 0 4.24 4.24"></path>
                                        <path d="M9.88 5.09A10.43 10.43 0 0 1 12 5c5.7 0 9.5 7 9.5 7a17.91 17.91 0 0 1-4.2 4.92"></path>
                                        <path d="M6.1 6.1C3.2 8.2 2.5 12 2.5 12s3.8 7 9.5 7c1 0 1.96-.14 2.86-.39"></path>
                        ...
                        <div class="sm:col-span-2 flex items-start gap-2">
                            <input type="checkbox" id="terms" class="mt-1 h-4 w-4 rounded border-slate-300 text-[#1d4ed8] focus:ring-[#1d4ed8]" name="terms" required>
                            <label for="terms" class="text-[10px] leading-[1.4] text-slate-500">
                                By creating an account, you agree to our
                                <a href="{{ route('terms') }}" class="font-extrabold text-[#1d4ed8] hover:underline">Terms of Service</a>
                                and
                                <a href="{{ route('privacy') }}" class="font-extrabold text-[#1d4ed8] hover:underline">Privacy Policy</a>.
                            </label>
                        </div>

                        <button type="submit" class="sm:col-span-2 flex h-[40px] w-full items-center justify-center gap-3 rounded-2xl bg-gradient-to-b from-[#1254c8] to-[#0a3ea0] text-[11px] font-extrabold text-white shadow-[0_20px_36px_rgba(10,62,160,0.32)] transition hover:-translate-y-[1px] hover:brightness-105">
                        ...
                        <p class="sm:col-span-2 text-center text-[9px] text-slate-500">
                            Already registered? <a href="{{ route('login') }}" class="font-extrabold text-[#1d4ed8] hover:underline">Sign in</a>
                        </p>

                        <div class="sm:col-span-2 my-1 flex items-center gap-3 text-[7px] font-extrabold uppercase tracking-[0.16em] text-slate-400">
                            <span class="h-px flex-1 bg-slate-200"></span>
                            <span>Or continue with</span>
                            <span class="h-px flex-1 bg-slate-200"></span>
                        </div>

                        <a href="{{ route('auth.google') }}" class="sm:col-span-2 flex h-[40px] w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white text-[11px] font-extrabold text-[#223056] transition hover:-translate-y-[1px] hover:border-slate-300 hover:shadow-[0_10px_24px_rgba(16,36,87,0.08)]">
    ...
    <script>
        ...
        confirmPasswordToggle.addEventListener('click', function () {
            ...
            confirmEyeOpen.classList.toggle('hidden', hidden);
            confirmEyeClosed.classList.toggle('hidden', !hidden);
            confirmPasswordToggle.setAttribute('aria-label', hidden ? 'Hide password' : 'Show password');
        });
    </script>
</body>
</html>
